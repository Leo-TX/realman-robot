...
def train():
    train_dataset_dir = r'./data/lever_handle/train2'
...
def eval():
    eval_dataset_dir = r'./data/lever_handle/eval2' 
    model_load_path = r'./checkpoints/hgum2.pth'
...
def test_images():
    ...
    root_dir = r'./data/lever_handle/test2/'
...
def main():
    ...
    image_path = r'.data/lever_handle/test2/035_0_0.png/'
    mask_path = image_path.replace('.png','_mask.png')
