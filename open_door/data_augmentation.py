...
class DataAugmentator:
        ...
        for filename in os.listdir(self.input_dir):
            if filename.endswith(".png"):
                ...
                if os.path.exists(json_path):
                    ...
                    self.augment_single_image(image_path, data)
    ...
    def augment_single_image(self, image_path, data):
        """
        ...
        for i in range(self.translation_num):
            for j in range(self.resize_num):
                ...
                translated_data = self.adjust_annotations(resized_data.copy(), tx, ty, 1)  # 只平移，不缩放
...
if __name__ == "__main__":
    input_dir = r'E:\realman-robot\open_door\data\images3_png'
    output_dir = r'E:\realman-robot\open_door\data\images3_png_aug'
